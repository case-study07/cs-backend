...
export default function Delivery(): ReactNode{
    ...
    return (
      <div className={d.delivery}>
        <nav>
          <ul className={d.pankuzu}>
            <li><a>プロフィールトップ</a></li>
            <li>&gt;&gt;</li>
            <li>配送方法</li>
          </ul>
        </nav>
        <article className={d.deliveryForm}>
          <h2>配送方法</h2>
          <form action="">
            <div>
              <div>
        ...
        <article>
          <h2 className={d.carName}>日産スカイライン 3.0 GT タイプSP</h2>
          <div>
            <img src="./img/Featured image.png" className={d.carImage} alt="" />
            <div className={d.carOthers}>
